...
public class BraceleteStateMachine extends StateMachine {
    ...
    private static com.capitalbio.oemv2.myapplication.Devices.Bracelete.BraceleteStateMachine mInstance;
    ...
    private BraceleteStateMachine(BraceleteDevices bleService) {
    ...
    public static com.capitalbio.oemv2.myapplication.Devices.Bracelete.BraceleteStateMachine make(Context context, BraceleteDevices bleService) {
        Log.d(TAG, "BloodPressStateMachine make.....");
        
        if (mInstance == null) {
            mInstance = new com.capitalbio.oemv2.myapplication.Devices.Bracelete.BraceleteStateMachine(bleService);
            mInstance.start();
        }
