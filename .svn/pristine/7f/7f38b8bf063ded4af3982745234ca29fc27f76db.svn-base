package com.capitalbio.oemv2.myapplication.FirstPeriod.Final;
...
public class Base_Url {
   ...
   //  上传数据
	...
	//public static String Url_Base = "http://192.168.33.51:8080/service";// http://182.92.244.204:18087/service //http://192.168.9.130:8080/service
	...
	//下载数据过去24小时 整点数据
	public static String download24hour_Url = "/data/lshd_app/hour?";
	//下载数据的总条数
	...
	//百度天气 api
	public static String BAIDU_WEATHER_API = "http://apis.baidu.com/apistore/weatherservice/cityname?";
