...
public class BraceleteFragmentDaySleep extends BaseFragment  implements OnChartValueSelectedListener {
   ...
   /*     tv_distance = (TextView) view.findViewById(R.id.tv_distance);
    ...
    protected void processLogic() {
        ...
        List<Map<String,String>> wake = new ArrayList<>();
        Map<String,String> map2 = new HashMap<>();
        map2.put("time","1441776129000");
        map2.put("widthtime","900000");
        wake.add(map2);
        List<Map<String,String>> noise = new ArrayList<>();
        Map<String,String> map3 = new HashMap<>();
        map3.put("time",(1441771356000l-8*60*60*1000)+"");
        map3.put("value","21");

        Map<String,String> map4 = new HashMap<>();
        map4.put("time",(1441771356000l-8*60*60*1000+600000)+"");
        map4.put("value", "25");
        noise.add(map3);
        noise.add(map4);

        Map<String,String> map5 = new HashMap<>();
        map5.put("time",(1441771356000l-8*60*60*1000+1200000)+"");
        map5.put("value", "80");
        noise.add(map3);
        noise.add(map4);
        noise.add(map5);
        sleepView.setSleepData(shenshui,qianshui,wake,noise);
       /* initchar();
        setData(24, 50);*/
