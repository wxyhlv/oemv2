...
import com.capitalbio.oemv2.myapplication.View.adapter.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0xeeffffff, 0x33ffffff, 0x33ffffff };
