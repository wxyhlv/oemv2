            ...
            synchronized (insertLock) {
                ...
                try {
                    if (!isDataTranfer) {
                        ...
                        PreferencesUtils.putString(mContext, MyApplication.getInstance().getCurrentUserName() + "blood_press_latest_meausre_time", com.capitalbio.oemv2.myapplication.Utils.TimeStampUtil.latestTestTime(0));
