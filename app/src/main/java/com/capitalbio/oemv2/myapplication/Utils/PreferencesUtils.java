...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "HUROM";
    ...
    public static boolean putString(Context context, String key, String value) {
       // Log.e("PREFERENCE_NAME",PREFERENCE_NAME + " nnnnn");
    ...
    public static String getString(Context context, String key, String defaultValue) {
       // Log.e("PREFERENCE_NAME",PREFERENCE_NAME + " getStringnnnnn");

        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, Context.MODE_PRIVATE);
       // Log.e("PREFERENCE_NAME", " key " + key);
       // Log.e("PREFERENCE_NAME", " getString " + settings.toString());

       // Log.e("PREFERENCE_NAME", " getString " + settings.getString(key, defaultValue));
