        ...
        switch (requestCode) {
            case SCANNIN_GREQUEST_CODE:
                if (resultCode == RESULT_OK) {
                    ...
                    Intent addIntent = new Intent(this, AircatScanResultActivtity.class);
                    addIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    addIntent.putExtra("result", bundle.getString("result"));
        ...
        try {
            ...
            HttpTools.post(this, Base_Url.Url_Base + Base_Url.AIRCAT_WIFI_DATA, jsonObject, new AsyncHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                    ...
                    //当前线程 主线程
                    PreferencesUtils.putString(AirCatActivity.this, MyApplication.getInstance().getCurrentUserName() + "aircat_latest_measure_time", TimeStampUtil.latestTestTime(0));
